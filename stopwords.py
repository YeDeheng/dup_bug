...
stop_words = Set(['a', 'ah', 'about', 'above', 'after', 'again',
                  'against', 'all', 'am', 'an', 'and', 'any', 'are',
                  "aren't", 'as', 'at', 'b', 'be', 'because', 'been',
                  'before', 'being', 'below', 'between', 'both',
                  'but', 'by', 'can', "can't", 'cannot', 'could', "couldn't",
                  'did', "didn't", 'do', 'does', 'doesnt', "doesn't", 'doing',
                  "don't", 'down', 'during', 'each', 'en', 'er',
                  'few', 'for', 'from', 'further', 'ha', 'had',
                  ...
                  'ourselves', 'out', 'over', 'own', 'quot', 'same',
                  ...
                  'with', "won't", 'would', "wouldn't", 'yes', 'you',
